...
# Load the textbook food-expenditure dataset directly from GitHub.
load(url("https://raw.githubusercontent.com/uit-sok-3081-h26/uit-sok-3081-h26.github.io/main/data/food.RData"))
